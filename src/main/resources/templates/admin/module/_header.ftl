<header class="main-header">
    <a href="/admin" class="logo">
        ...
        <span class="logo-lg"><b>Cup</b>id</span>
    </a>
            ...
            <ul class="nav navbar-nav">
               ...
               <#-- <@commonTag method="newComments">
                ...
                <li class="dropdown user user-menu">
                    <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="<#if user.userAvatar?if_exists!="">${user.userAvatar}<#else >/static/cupid-backend/images/default.png</#if>" class="user-image" alt="User Image">
                        <span class="hidden-xs">${user.userDisplayName!}</span>
                    </a>
                    <ul class="dropdown-menu">
                        <li class="user-header">
                            <img src="<#if user.userAvatar?if_exists!="">${user.userAvatar}<#else >/static/cupid-backend/images/default.png</#if>" class="img-circle" alt="User Image">
