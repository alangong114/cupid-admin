                    ...
                    <div class="box-body">
                        ...
                        <div class="media">
                            <div class="media-body">
                                <div class="clearfix">
                                    <p class="pull-right">
                                        <a href="#" class="btn btn-success btn-sm ad-click-event"  onclick="cupid.layerModal('/admin/tools/markdownImport','<@spring.message code="admin.tools.markdown.name" />')">
