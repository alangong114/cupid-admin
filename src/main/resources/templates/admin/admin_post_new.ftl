        ...
        <div class="row">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body pad">
                            <div id="markdown-editor-2">
                                <textarea id="editorarea2" style="display:none;"></textarea>
                            </div>
                        </div>
                    </div>
                <#compress >
            ...
            <div class="col-md-3">
                                ...
                                <@commonTag method="categories">
                                    <#list categories as cate>
                                        ...
                                        <input name="categories" id="categories" type="checkbox"
                                         <#if cate_index=0></#if> checked="true"
                                                                                                 class="minimal"
                                        value="${cate.cateId?c}">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div>
                            <img src="/static/cupid-frontend/images/thumbnail/thumbnail.png"
