...
<head>
    ...
    <link rel="stylesheet" href="/static/cupid-backend/plugins/fileinput/fileinput.min.css">
...
<script src="/static/cupid-backend/plugins/clipboard/clipboard.min.js"></script>
...
<script>
    ...
    $('#uploadImg').fileinput({
        ...
        $("#uploadForm").hide(400);
        cupid.showMsgAndReload('上传成功！','success',1000);
    });
    $(document).ready(function(){
        var clipboard = new Clipboard('.thumbnail');
    });
    $('.thumbnail').click(function () {
        cupid.showMsg("<@spring.message code='admin.attachments.modal.js.copy-success' />",'success',1000);
    })
</script>
</html>
