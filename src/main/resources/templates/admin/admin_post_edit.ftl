...
<div class="content-wrapper">
    <link rel="stylesheet" href="/static/cupid-backend/plugins/easymde/easymde.min.css">
    <link rel="stylesheet" href="/static/cupid-backend/plugins/jquery-tageditor/jquery.tag-editor.css">
    <link rel="stylesheet" href="/static/cupid-backend/plugins/datetimepicker/css/bootstrap-datetimepicker.min.css">
    <style type="text/css">
        #postTitle {
            font-weight: 400;
        }
    ...
    <section class="content-header" id="animated-header">
        ...
        <a class="btn-header" id="btnOpenAttach" href="javascript:void(0)"
           onclick="cupid.layerModal('/admin/attachments/select?type=post','<@spring.message code="common.js.all-attachment" />')">
            <@spring.message code='admin.editor.btn.attachs' />
        </a>
        <ol class="breadcrumb">
            <li>
                <a data-pjax="true" href="javascript:void(0)"><i
            ...
            <div class="col-md-9">
                ...
                <div style="margin-bottom: 10px;">
                    <input type="text" class="form-control input-lg" id="postTitle" name="postTitle"
                           placeholder="<@spring.message code='admin.posts.edit.form.title.placeholder' />"
                           onblur="autoComplateUrl();" value="${post.postTitle!}" autocomplete="off">
                    <input type="text" class="form-control input-lg" id="postUsTitle" name="postUsTitle"
                           placeholder="<@spring.message code='admin.posts.edit.form.title.placeholder.us' />"
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body pad">
                        ...
                        <div id="markdown-editor-2">
                            <textarea id="editorarea2" style="display:none;">${post.postUsContentMd!}</textarea>
                        </div>
                    </div>
                </div>
                <#compress >
            ...
            <div class="col-md-3">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="postDate"
                                   class="control-label"><@spring.message code='admin.editor.post.date' /></label>
                            <input type="text" class="form-control" id="postDate" name="postDate"
                                   value="${post.postDate!?string('yyyy-MM-dd HH:mm')}">
                        </div>
                    </div>
                    <div class="box-footer">
                        <button onclick="push(1)"
                                class="btn btn-default btn-sm "><@spring.message code='admin.editor.save-draft' /></button>
                        <button onclick="push(0)" class="btn btn-primary btn-sm pull-right "
                                data-loading-text="<@spring.message code='admin.editor.btn.pushing' />">
                        ...
                        <div class="form-group">
                            <ul style="list-style: none;padding: 0px;margin: 0px;">
                                <@commonTag method="categories">
                                    ...
                                    <#list post.categories as postCate><#if postCate.cateId = cate.cateId>checked="checked"</#if></#list>>
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div>
                            <img src="${post.postThumbnail!'/static/cupid-frontend/images/thumbnail/thumbnail.png'}"
                                 class="img-responsive img-thumbnail" id="selectImg"
                                 onclick="cupid.layerModal('/admin/attachments/select?id=selectImg','<@spring.message code="common.js.all-attachment" />')"
                                 style="cursor: pointer;">
                        </div>
                    </div>
                    <div class="box-footer">
                        <button onclick="removeThumbnail()"
                                class="btn btn-default btn-sm "><@spring.message code='common.btn.remove' /></button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type="application/javascript" id="footer_script">
        ...
        var easyMDE2 = new EasyMDE({
            element: document.getElementById("editorarea2"),
            autoDownloadFontAwesome: false,
            autofocus: true,
            autosave: {
                enabled: true,
                uniqueId: "editor-temp-us-${post.postId?c}",
                delay: 10000
            },
            renderingConfig: {
                codeSyntaxHighlighting: true
            ...
            previewRender: function (plainText) {
                var preview = document.getElementsByClassName("editor-preview-side")[1];
                preview.innerHTML = this.parent.markdown(plainText);
                preview.setAttribute('id', 'editor-preview2');
                MathJax.Hub.Queue(["Typeset", MathJax.Hub, "editor-preview2"]);
                return preview.innerHTML;
            },
            showIcons: ["code", "table"],
            status: ["autosave", "lines", "words"],
         ...
         */
        $(function () {
            inlineAttachment.editors.codemirror4.attach(easyMDE2.codemirror, {
                progressText: "![上传中...]()",
                uploadUrl: "/admin/attachments/upload"
            });
        });
        ...
        function push(status) {
            ...
            var postUsTitle = $("#postUsTitle");

            var postUrl = $("#postUrl");
            var cateList = new Array();
            if (!postTitle.val()) {
                cupid.showMsg("<@spring.message code='admin.editor.js.no-title' />", 'info', 2000);
                return;
            }
            if (!postUrl.html()) {
                cupid.showMsg("<@spring.message code='admin.editor.js.no-url' />", 'info', 2000);
            ...
            $.post('/admin/posts/update', {
                ...
                'postUsTitle': postUsTitle.val(),
                'postUrl': postUrl.html().toString(),
                'postContentMd': easyMDE.value(),
                'postUsContentMd': easyMDE2.value(),
                ...
                if (data.code === 1) {
                    ...
                    easyMDE2.toTextArea();
                    easyMDE2 = null;
                    cupid.showMsgAndRedirect(data.msg, 'success', 1000, '/admin/posts', "${options.admin_pjax!'true'}");
                } else {
                    cupid.showMsg(data.msg, 'error', 2000);
                }
            }, 'JSON')
        ...
        function removeThumbnail() {
            $("#selectImg").attr("src", "/static/cupid-frontend/images/thumbnail/thumbnail.png");
        }
    </script>
    </@footer>
</#compress>
