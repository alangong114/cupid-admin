                                    ...
                                    <#list postTopFive as post>
                                        <tr>
                                            <#if post.postStatus == 0>
                                                <td><a data-pjax="true" href="/admin/posts/edit?postId=${post.postId?c}">${post.postTitle}</a></td>
                                            <#else >
                        ...
                        <div class="box-tools">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-right" role="menu">
                                    <li><a href="javascript:void(0)" onclick="cupid.layerModal('/admin/logs','<@spring.message code="admin.index.widgets.text.all-logs" />')"><@spring.message code='common.btn.view-all' /></a></li>
