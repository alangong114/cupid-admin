                ...
                <div class="box box-primary">
                        ...
                        <table class="table table-hover">
                            ...
                            <#if posts.content?size gt 0>
                                <#list posts.content as post>
                                    ...
                                    <a data-pjax="true" href="/admin/posts/edit?postId=${post.postId?c}">${post.postTitle}</a>
                                    <#else>
                                        ${post.postTitle}
                                    </#if>
                                    </td>
                                    ...
                                    <#switch post.postStatus>
                                        ...
                                        class="btn btn-info btn-xs "><@spring.message code="common.btn.edit" /></a>
                                            ...
                                            <#break >
                                        <#case 2>
                                            <a data-pjax="true" href="/admin/posts/revert?postId=${post.postId?c}&status=2"
                    ...
                    <div class="box-footer clearfix">
                        ...
                        <div class="btn-group pull-right btn-group-sm" role="group">
                            ...
                            <a data-pjax="true" class="btn btn-default <#if !posts.hasPrevious()>disabled</#if>"
                               href="/admin/posts?status=${status}&page=${posts.number-1}">
                            ...
                            <a data-pjax="true" class="btn btn-default <#if !posts.hasNext()>disabled</#if>"
                               href="/admin/posts?page=${posts.totalPages-1}&status=${status}">
