...
<div class="content-wrapper">
    ...
    <section class="content-header" id="animated-header">
        ...
        <a class="btn-header" id="btnOpenAttach" href="javascript:void(0)" onclick="cupid.layerModal('/admin/attachments/select?type=post','<@spring.message code="common.js.all-attachment" />')">
...
<#compress >
            ...
            <div class="col-md-3">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div>
                            <img src="<#if post??>${post.postThumbnail!'/static/cupid-frontend/images/thumbnail/thumbnail.png'}<#else>/static/cupid-frontend/images/thumbnail/thumbnail.png</#if>" class="img-responsive img-thumbnail" id="selectImg" onclick="cupid.layerModal('/admin/attachments/select?id=selectImg','<@spring.message code="common.js.all-attachment" />')" style="cursor: pointer;">
                        </div>
                    </div>
                    <div class="box-footer">
    ...
    function push(status) {
        ...
        $.post('/admin/page/new/push',{
            ...
            if(data.code===1){
                ...
                easyMDE.toTextArea();
                easyMDE = null;
                cupid.showMsgAndRedirect(data.msg,'success',1000,'/admin/page',"${options.admin_pjax!'true'}");
            }else{
                cupid.showMsg(data.msg,'error',2000);
            }
        },'JSON');
