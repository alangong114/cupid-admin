                    ...
                    <div class="tab-pane" id="style">
                        <form method="post" class="form-horizontal" id="anatoleStyleOptions">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="anatoleStyleBlogTitleLower" class="col-sm-4 control-label">网站标题大写：</label>
                                    <div class="col-sm-8">
                                        <label class="radio-inline">
                                ...
                                <div class="form-group">
                                    <label for="anatoleStyleHitokoto" class="col-sm-4 control-label">网站描述开启一言：</label>
                                    <div class="col-sm-8">
                                        <label class="radio-inline">
