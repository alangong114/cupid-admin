...
<link type="text/css" rel="stylesheet" href="/static/cupid-common/OwO/OwO.min.css">
<link type="text/css" rel="stylesheet" href="/static/cupid-frontend/css/comment.min.css">
<style>
${options.native_css!}
</style>
...
<script src="/static/cupid-frontend/plugins/md5/md5.min.js"></script>
<script src="/static/cupid-frontend/plugins/ua-parser/ua-parser.min.js"></script>
<script src="/static/cupid-common/OwO/OwO.min.js"></script>
<#if (options.comment_activate_power_mode!'false') == "true">
<script src="/static/cupid-frontend/plugins/activate-power-mode/activate-power-mode.js"></script>
<script>
...
<script src="/static/cupid-frontend/js/comment.min.js"></script>
</@compress>
