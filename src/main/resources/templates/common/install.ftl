...
<html lang="zh">
    <head>
        ...
        <link rel="stylesheet" href="/static/cupid-backend/plugins/bootstrapvalidator/css/bootstrapValidator.min.css">
        <!--[if lt IE 9]>
            ...
            <div class="row" style="padding-top: 50px">
                <div class="col-lg-12 col-xs-12">
                    <div class="logo animated fadeInUp">
                        Cupid<small style="font-size: 14px;"><@spring.message code='install.page.title'/></small>
                    </div>
                    <#if isInstall==false>
    ...
    <script src="/static/cupid-backend/plugins/bootstrapvalidator/js/bootstrapValidator.min.js"></script>
    <script src="/static/cupid-backend/plugins/bootstrapvalidator/js/language/zh_CN.js"></script>
    <#if isInstall==false>
    <script>
