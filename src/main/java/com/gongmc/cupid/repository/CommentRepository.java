...
public interface CommentRepository extends BaseRepository<Comment, Long> {
     ...
     * @return List
     */
    @Query(value = "SELECT * FROM cupid_comment ORDER BY comment_date DESC LIMIT 5", nativeQuery = true)
     ...
     * @return List
     */
    @Query(value = "SELECT * FROM cupid_comment WHERE comment_status = 0 ORDER BY comment_date DESC LIMIT :limit", nativeQuery = true)
